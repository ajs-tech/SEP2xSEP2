...
public class DAOTestRunner {
  ...
  public static void main(String[] args) {
    ...
    ReservationManager reservationManager = new ReservationManager(); // Opret ReservationManager til at sende til Laptop konstruktør

    // --- Test Data ---
    // Brug den nye konstruktør med ReservationManager
    Laptop testLaptop = new Laptop("ManualTest", "DAO-Check", 256, 8, PerformanceTypeEnum.LOW, reservationManager);
